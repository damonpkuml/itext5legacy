...
/*
  在header.pdf,footer.pdf中 插入内容组成新的pdf
 */
public class SimpleTable8 {
    ...
    public void createPdf(String dest) throws IOException, DocumentException {
        ...
        PdfReader reader = new PdfReader("src/main/resources/pdfs/header.pdf");
        ...
        reader = new PdfReader("src/main/resources/pdfs/footer.pdf");
